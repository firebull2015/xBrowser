...
//const char kDefaultUrl[] = "https://sso.douyin.com";
//const char kDefaultUrl[] = "https://www.kuaishou.com";
const char kDefaultUrl[] = "https://www.tiktok.com/";
...
// Choose a reasonable default rate based on the OSR mode.
  ...
  if (use_chrome_runtime_ && !use_views_) {
    ...
    // styled Chrome window with xBrowser menu customizations). In the mean
...
//Sec-Ch-Ua = "\"Microsoft Edge\";v=\"125\", \"Chromium\";v=\"125\", \"Not.A \/ Brand\";v=\"24\"";
  //CefString(&settings->user_agent) = "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/125.0.0.0 Safari/537.36 Edg/125.0.0.0";
  //CefString(&settings->user_agent_product) = "\"Microsoft Edge\";v=\"125\", \"Chromium\";v=\"125\", \"Not.A / Brand\";v=\"24\"";
}
