...
#include "xBrowser/browser/root_window.h"

#include "xBrowser/browser/root_window_views.h"

#if defined(OS_WIN)
#include "xBrowser/browser/root_window_win.h"
#elif defined(OS_LINUX)
#include "xBrowser/browser/root_window_gtk.h"
#elif defined(OS_MAC)
#include "xBrowser/browser/root_window_mac.h"
#endif
